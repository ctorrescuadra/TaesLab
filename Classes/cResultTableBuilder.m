...
%
    ...
    methods
        ...
        % Get the thermoeconomic analysis result tables
        % Syntax:
        ...
        % Get the thermoeconomic diagnosis tables
        % Syntax:
        ...
        % Get the Waste analysis result tables
        % Syntax:
        ...
        % Get the diagram FP adjacency tables
        % Syntax:
