...
%                 
	properties (Constant)
		...
		MAX_RESULT_INFO=9         % Maximun cResultInfo groups
		...
		Tables=struct('FLOW_TABLE','flows','PROCESS_TABLE','processes','STREAM_TABLE','streams',...
			...
			'PROCESS_DIAGRAM','pat','KPROCESS_DIAGRAM','kpat',...
        ...
        ResultId=struct('PRODUCTIVE_STRUCTURE',1,'THERMOECONOMIC_STATE',2,'THERMOECONOMIC_ANALYSIS',3,...
            'WASTE_ANALYSIS',4,'THERMOECONOMIC_DIAGNOSIS',5,'PRODUCTIVE_DIAGRAM',6,...
			'SUMMARY_RESULTS',7,'DATA_MODEL',8,'RESULT_MODEL',9);
		% Names for cModelResults	
		Results={'Productive Structure','Exergy Analysis','Thermoeconomic Analysis',...
			'Waste Analysis','Thermoeconomic Diagnosis','Productive Diagram',...
			'Summary Results','Data Model','Model Results'};
		ResultVar={'productiveStructure','exergyAnalysis','thermoeconomicAnalysis',...
			'wasteAnalysis','thermoeconomicDiagnosis','productiveDiagram',...
			'summaryResults','dataModel','modelResults'};
		TABLE_INDEX='tindex';
        ResultIndex={'psindex','eaindex','taindex','waindex','tdindex','pdindex','srindex',...
            'dmindex','rmindex'};
		% Save extensions
