...
%                 
	properties (Constant)
		...
		CellTable=struct('FLOW_EXERGY_COST',1,'FLOW_GENERALIZED_COST',2,'PROCESS_COST',3,...
			...
			'PROCESS_EXERGY',11,'STREAM_EXERGY',12,'FLOW_EXERGY',13,'FP_ADJACENCY_TABLE',14,'WASTE_DEFINITION',15);
		% Matrix Tables
		...
		Tables=struct('FLOW_TABLE','flows','PROCESS_TABLE','processes','STREAM_TABLE','streama',...
			'FLOW_EXERGY','eflows','PROCESS_EXERGY','eprocesses','STREAM_EXERGY','estreams','TABLE_FP','tfp','FP_ADJACENCY_TABLE','atfp',...
